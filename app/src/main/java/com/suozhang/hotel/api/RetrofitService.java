...
public class RetrofitService {
    ...
    public static Observable<NewsInfo> getNewsInfo(String newsId, int page) {
        String type = "";
        //判断是不是新闻专题
        ...
        return  null;
//                sNewsService.getNewsList(type, newsId, page * INCREASE_PAGE)
...
//                .flatMap(flatMapNews(newsId));
    ...
    public static Func1<Map<String, List<NewsInfo>>, Observable<NewsInfo>> flatMapNews(final String newsType) {
        return new Func1<Map<String, List<NewsInfo>>, Observable<NewsInfo>>() {
            ...
            public Observable<NewsInfo> call(Map<String, List<NewsInfo>> stringListMap) {
                return Observable.from(stringListMap.get(newsType));
            }
        };
    }
